 ...
 <div class="flex-dashboard">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li class="sidebar_logout">
                        ...
                        <a href="../views/index.html">LOGOUT</a>
                    </li>
        ...
        <main id="mainContent">
            <header>
                ...
                <a href="../views/login.html "><i class="fas fa-sign-out-alt "></i> &nbsp; Logout</a>
            </header>
            ...
            <div class="container-fluid">
                <div class="main-content ">
                    <div class="Castle">
                        <i class="fas fa-chevron-left"></i> &nbsp; &nbsp; <p>HOJE</p> &nbsp; &nbsp;<i
                            class="fas fa-chevron-right"></i>
                    </div>
                    <div class="row justify-content-center">
                        <div class='col-sm-10 col-md-10 col-lg-10'>
                            <div class="dashboard-kcal">
                                <h3>369 &nbsp;<span>Kcal</span><br></h3>
                                CALORIAS INGERIDAS
                                <div class="p-calorias">
                                    <p><span>Manhã:</span> 123 Kcal&nbsp;&nbsp;&nbsp;&nbsp;
                                        <span>Tarde:</span> 123 Kcal&nbsp;&nbsp;&nbsp;&nbsp;
                                        <span>Noite:</span> 123 Kcal&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </p>
                                </div>
                            </div>
                        </div>
